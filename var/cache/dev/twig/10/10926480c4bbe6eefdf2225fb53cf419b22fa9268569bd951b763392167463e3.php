...
class __TwigTemplate_bdc4afd033225f6383680d1fceb4266695093a50da49041f5d7ca4cd33e8d321 extends Twig_Template
{
    private $source;
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 7
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/d product 8.jpg"), "html", null, true);
        echo "\" height=\"200\" alt=\"choosit\" />
    </div>
    <div class=\"jumbotron text-center\">
    <p>Choosit agence digital depuis 1998 - Création de site internet responsive à Montpellier. Expert Drupal, Prestashop et Wordpress.</p>
    </div>
...
{% block title %}ChoosIt{% endblock %}

{% block body %}
    <div class=\"text-center\">
        <img  class=\"image-style\" src=\"{{ asset(\"images/d product 8.jpg\")}}\" height=\"200\" alt=\"choosit\" />
    </div>
    <div class=\"jumbotron text-center\">
    <p>Choosit agence digital depuis 1998 - Création de site internet responsive à Montpellier. Expert Drupal, Prestashop et Wordpress.</p>
    </div>

{% endblock %}", "pages/home.html.twig", "C:\\wamp64\\www\\catalogue\\templates\\pages\\home.html.twig");
    }
}
